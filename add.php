...
<head>
    ...
    <title>Registration Add Page</title>
        ...
        <div class="col-md-6 mt-auto">
            <div class="card">
                <div class="card-title" >
                    <h2 class="text-center py-2">Registraition Form</h2>
                </div>
                <div class="card-body">
                    <form action="register_code.php" method="post">
                        <table class="table">
                            ...
                            <tr>
                                <td>Address</td>
                                <td>:</td>
                                <td><textarea name="address" id="address" cols="8" rows="3" class="form-control mt-2" required></textarea></td>
                            </tr>
                            <tr>
                                <td>State</td>
                                <td>:</td>
